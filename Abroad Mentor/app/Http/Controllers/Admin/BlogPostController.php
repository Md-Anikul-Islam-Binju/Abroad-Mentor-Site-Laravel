...
class BlogPostController extends Controller
{
   ...
   {
     $blog_info = DB::table('blogs')->where('id',$id)->first();
     return view('admin.blog.edit_blog',compact('blog_info'));
   }
       ...
       $image=$request->file('image');
           if ($image){              
               ...
               $blog=DB::table('blogs')->where('id',$id)->update($data);
                ...
                $notification=array(
                    'messege'=>'Blog Update without Image !',
                    'alert-type'=>'success'
                     );
               return Redirect()->route('all.blog')->with($notification); 
           }
