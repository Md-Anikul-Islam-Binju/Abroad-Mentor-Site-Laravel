...
class SettingController extends Controller
{
   ...
   //site setting
    ...
    {   
      ...
      $notification=array(
                     'messege'=>'Successfully Site Setting Information Active',
                     'alert-type'=>'success'
                    );
      return Redirect()->back()->with($notification);
    ...
    public function Active($id)
    {
      ...
      $notification=array(
                     'messege'=>'Successfully Site Setting Information Inactive',
                     'alert-type'=>'success'
                    );
      return Redirect()->back()->with($notification);
    }
    ...
    {
    	$setting_info = DB::table('settings')->where('id',$id)->first();
    	return view('admin.setting.edit_setting',compact('setting_info'));
    }
    ...
    public function UpdateSetting(Request $request,$id)
    {
    	...
    	if ($update) {
    		$notification=array(
                        'messege'=>'Setting Information Update Success',
                        'alert-type'=>'success'
                         );
    	...
    	else
    	{
    		...
    		$notification=array(
                        'messege'=>'Setting Information Do Not Update',
                        'alert-type'=>'success'
                         );
        return Redirect()->route('admin.setting')->with($notification);
