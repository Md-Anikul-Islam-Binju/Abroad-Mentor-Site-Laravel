    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        <div class="sl-page-title">
          <h5>Abroad Mentor Slider Table</h5>

        </div>

        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Abroad Mentor Slider
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content tx-size-sm">
              <div class="modal-header pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">*******************Abroad Mentor Slider Add *******************</h6>
             ...
             <div class="form-group">
               <label for="exampleInputCategory">Slider Image(Please Use 1920*1200 pixel)</label>
